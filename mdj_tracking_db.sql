...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2026 at 02:46 AM
...
INSERT INTO `files` (`id`, `department`, `tahun`, `no_kotak_fail`, `no_fail_permohonan`, `tarikh_permohonan_masuk`, `lot_pt`, `mukim`, `aras`, `kabinet`, `created_by`, `created_at`, `updated_at`) VALUES
(8, 'Kejuruteraan', 2003, '01', 'AUTO-KEJ-2003-01-20260312-A997D0', '2003-02-11', '', '', 1, 'A', 1, '2026-03-12 07:07:55', '2026-03-12 07:07:55');
...
(27, 3, '', 'Kemas Kini Surat', 'Jabatan Penguatkuasa kemas kini status: Diproses', '/surat_view.php?id=2', 1, '2026-03-12 14:57:04', '2026-02-25 11:00:57'),
(28, 4, '', 'Surat Masuk Baru', 'No. Fail: -', '/surat_view.php?id=26', 1, '2026-03-12 14:58:11', '2026-03-12 14:57:45'),
(29, 1, '', 'Kemas Kini Surat', 'Jabatan Penguatkuasa kemas kini status: Diproses', '/surat_view.php?id=26', 0, NULL, '2026-03-12 14:58:20'),
(30, 3, '', 'Kemas Kini Surat', 'Jabatan Penguatkuasa kemas kini status: Diproses', '/surat_view.php?id=26', 1, '2026-03-12 14:58:51', '2026-03-12 14:58:20'),
(32, 1, '', 'Kemas Kini Surat', 'Jabatan Penguatkuasa kemas kini status: Selesai', '/surat_view.php?id=26', 0, NULL, '2026-03-12 14:58:26'),
(33, 3, '', 'Kemas Kini Surat', 'Jabatan Penguatkuasa kemas kini status: Selesai', '/surat_view.php?id=26', 1, '2026-03-12 14:58:50', '2026-03-12 14:58:26'),
(35, 4, '', 'Surat Masuk Baru', 'No. Fail: KPKT/0002', '/surat_view.php?id=27', 1, '2026-03-12 15:12:09', '2026-03-12 15:11:41'),
(36, 1, '', 'Kemas Kini Surat', 'Jabatan Penguatkuasa kemas kini status: Diproses', '/surat_view.php?id=27', 0, NULL, '2026-03-12 15:12:26'),
(37, 3, '', 'Kemas Kini Surat', 'Jabatan Penguatkuasa kemas kini status: Diproses', '/surat_view.php?id=27', 0, NULL, '2026-03-12 15:12:26'),
(38, 8, '', 'Kemas Kini Surat', 'Jabatan Penguatkuasa kemas kini status: Diproses', '/surat_view.php?id=27', 0, NULL, '2026-03-12 15:12:26');
...
INSERT INTO `surat_menyurat` (`id`, `tarikh_penerimaan`, `no_fail_kementerian`, `tarikh_surat`, `daripada_siapa`, `perkara`, `dikirim_kepada`, `tindakan`, `tempoh_menjawab`, `status`, `tarikh_dijawab`, `catatan`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(26, '2026-03-12', '-', '2026-03-13', 'Pentadbiran', 'Test 1', 'Penguatkuasa', 'Segera', '7', 'Selesai', NULL, '-', NULL, NULL, '2026-03-12 07:57:45', '2026-03-12 14:58:26'),
(27, '2026-03-12', 'KPKT/0002', '2026-03-10', 'Pentadbiran', 'test 2', 'Penguatkuasa', 'Segera', '7', 'Diproses', NULL, '', NULL, NULL, '2026-03-12 08:11:41', '2026-03-12 15:12:26'),
(28, '2026-03-17', 'KPKT/0010', '2026-03-13', 'SELIA Group', 'Untuk Tindakan KPT', 'Pentadbiran', 'Segera', '2', 'Diterima', NULL, '', NULL, NULL, '2026-03-26 03:03:45', '2026-03-26 03:03:45');
...
--
-- Dumping data for table `surat_recipients`
--

INSERT INTO `surat_recipients` (`id`, `surat_id`, `recipient_department`, `status`, `comment`, `due_date`, `responded_at`, `created_at`, `updated_at`) VALUES
(24, 26, 'Penguatkuasa', 'Selesai', '', '2026-03-19', '2026-03-12 14:58:26', '2026-03-12 07:57:45', '2026-03-12 14:58:26'),
(25, 27, 'Penguatkuasa', 'Diproses', 'updated', '2026-03-19', '2026-03-12 15:12:26', '2026-03-12 08:11:41', '2026-03-12 15:12:26'),
(26, 28, 'Pentadbiran', 'Diterima', NULL, '2026-03-19', NULL, '2026-03-26 03:03:45', '2026-03-26 03:03:45');
...
(1, 'admin', 'admin@mdj.gov.my', '$2y$10$Zrt5QWdBRelVkWheEFfa/.W3I2PxYwMQG/gc/ijMGeLV..98fKZ6a', 'System Administrator', 'admin', 'IT Department', '2026-01-27 03:35:03', '2026-03-26 01:59:50', 'active'),
(3, 'asyraf', 'Asyraf@mdj.gov.my', '$2y$10$3CZqm8ADWyXDP7OxT21.b.YEs15v..peON7nQLdjlQIu8YkC0MlwW', 'Asyraf', 'staff', 'Pentadbiran', '2026-02-09 07:27:45', '2026-03-12 07:12:51', 'active'),
(4, 'hakim', 'Hakim@mdj.gov.my', '$2y$10$vnCQW4nXlKQtnLd.Q8YXZ.hXxPu3ADe6rqdifkjMx0ExLjh0T5dmm', 'Hakim', 'staff', 'Penguatkuasa', '2026-02-16 04:02:19', '2026-03-12 07:11:58', 'active'),
...
(8, 'szulyazan', 'szulyazan@mdj.gov.my', '$2y$10$9AxFEFZotH9ZSapyMaT9ge19jp.PqYd.UEZQ4zVWnUxJ.d6vfehze', 'Asyraf', 'staff', 'Pentadbiran', '2026-03-12 07:05:51', '2026-03-12 07:06:09', 'active');
